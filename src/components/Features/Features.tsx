...
export const PromoBanner: React.FC<PromoBannerProps> = ({
  ...
  return (
    <div className="relative overflow-hidden rounded-3xl 
       ...
       <div className="relative z-10 flex flex-col lg:flex-row items-center 
        ...
        <div className="max-w-lg">
          ...
          <h2 className="text-4xl font-bold mb-4">
            {title}
            <span className="block text-5xl mt-2 text-yellow-300">
              {discount}
            </span>
          </h2>
          ...
          <div className="flex flex-col sm:flex-row items-center gap-4">
            <button className="px-8 py-3 bg-white text-blue-600 font-bold 
            ...
            <div className="flex items-center gap-3">
              <div className={`w-3 h-3 rounded-full ${isExpired ? 'bg-red-500' : 'bg-green-400 animate-pulse'}`} />
         ...
         <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 
                       border border-white/20 shadow-2xl min-w-[350px]">
          ...
          <div className="flex justify-center gap-3 mb-6">
            {timerData.map((time, index) => (
              <div key={index} className="text-center">
                <div className="bg-white/20 rounded-lg p-4 mb-2 min-w-[70px] 
           ...
           {isExpired && (
            <div className="text-center py-4">
              ...
              <button className="mt-4 px-6 py-2 bg-white/20 hover:bg-white/30 
       ...
       <div className="absolute -bottom-8 -left-8 w-40 h-40 bg-yellow-400/10 
                    rounded-full blur-2xl" />
      <div className="absolute -top-8 -right-8 w-40 h-40 bg-blue-400/10 
                    rounded-full blur-2xl" />
    </div>
  );
};
