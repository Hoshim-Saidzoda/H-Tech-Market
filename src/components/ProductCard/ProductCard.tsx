...
const ProductCard: React.FC<ProductCardProps> = ({ product }) => {
  ...
  return (
    <div className="relative group rounded p-2 w-full sm:w-70 hover:shadow-lg gap-17 f transition bg-white">
      <img
        src={`https://store-api.softclub.tj/images/${product.image}`}
        alt={product.productName}
        className="w-full h-84 sm:h-80 mb-2 rounded-lg cursor-pointer  "
      ...
      <button
        ...
        className="
          absolute bottom-1 left-53 -translate-x-1/2
          bg-gray-200 text-gray-950 px-6 py-1 rounded
