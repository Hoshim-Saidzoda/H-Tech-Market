...
const CategoryDetails: React.FC = () => {
  ...
  if (error || !category) return <p>Ошибка загрузки категории</p>;
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
            {category.subCategories.map((sub) => (
              <div
                ...
                className="bg-gray-50 hover:bg-gray-100 cursor-pointer rounded-xl shadow-sm
                  hover:shadow-md transition p-4 flex justify-center items-center text-center
